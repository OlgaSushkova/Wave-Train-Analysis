...
Phase_of_flashes= zeros(ExpectedNumberOfFlashes,1); %13-05-2021
Psi0_of_flashes= zeros(ExpectedNumberOfFlashes,1); %25-05-2021
...
Phase_of_flashes(:)= NaN; %13-05-2021
Psi0_of_flashes(:)= NaN; %25-05-2021
...
if	~Naidena_tochka_kotoraya_bolshe_Power_ij,
    ...
    Phase_of_flashes(Number_of_peaks)= angle(Matrix(i,j)); %13-05-2021
	%
   
    Psi0 = Phase_of_flashes(Number_of_peaks)-2*pi*Frequencies(i)*Time(j); %25-05-2021
	
    while true,
		flag=false;
	%for a=1:round(abs(Psi0/(2*pi))), %25-05-2021
		if Psi0 > pi,
			Psi0= Psi0-2*pi;
			flag=true;
 		end;
    ...
    Psi0_of_flashes(Number_of_peaks)= Psi0; %25-05-2021
...
Phase_of_flashes= Phase_of_flashes(1:Number_of_peaks); %13-05-2021
Psi0_of_flashes= Psi0_of_flashes(1:Number_of_peaks); %25-05-2021
Durations_of_flashes_in_seconds= ...
...
New_Phase_of_flashes= zeros(Number_of_peaks,1); %13-05-2021
New_Psi0_of_flashes= zeros(Number_of_peaks,1); %25-05-2021
...
New_Phase_of_flashes(:)= NaN; %13-05-2021
New_Psi0_of_flashes(:)= NaN; %25-05-2021
...
for n=1:Number_of_peaks,
    ...
    New_Phase_of_flashes(counter9)= Phase_of_flashes(n);%13-05-2021
    New_Psi0_of_flashes(counter9)= Psi0_of_flashes(n);%25-05-2021
...
Phase_of_flashes= New_Phase_of_flashes(1:counter9); %13-05-2021
Psi0_of_flashes= New_Psi0_of_flashes(1:counter9); %25-05-2021
...
if save_flash_diagrams,
    ...
    Flash_Phase_Stack= Phase_of_flashes; %13-05-2021
    Flash_Psi0_Stack= Psi0_of_flashes; %25-05-2021
...
%SelectedChannelName= 'EMG2'; % включи это, если на самом деле считается Е4 
	...
	save(Save_Ampl_mat,'Flash_Ampl_Stack');
    	%
	Save_Phase_mat= [... %13-05-2021
		PathStr,'/',ShortName,ext,'_',...
		SelectedChannelName,'Phase','.mat'];
	save(Save_Phase_mat,'Flash_Phase_Stack');
    	%
	Save_Psi0_mat= [... %25-05-2021
		PathStr,'/',ShortName,ext,'_',...
		SelectedChannelName,'Psi0','.mat'];
	save(Save_Psi0_mat,'Flash_Psi0_Stack');
	%
