...
NumberOfFileNames,...
NumberOfCNames...
]= load_all_people_and_channels_phase(...
	InputFolder,...
	CName);
...
FN7= [InputFolder,'/',ShortName,ext,'_',CName{z},'Phase','.mat'];
FN8= [InputFolder,'/',ShortName,ext,'_',CName{z},'Time','.mat'];
FN9= [InputFolder,'/',ShortName,ext,'_',CName{z},'Psi0','.mat'];
...
S6= load(FN6,'Time');
S7= load(FN7,'Flash_Phase_Stack');
S8= load(FN8,'Flash_Time_Stack');
S9= load(FN9,'Flash_Psi0_Stack');
...
MegaStructure(i).(CName{z}){7}= S7;
MegaStructure(i).(CName{z}){8}= S8;
MegaStructure(i).(CName{z}){9}= S9;
%:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::%
		%
	end;
end;
